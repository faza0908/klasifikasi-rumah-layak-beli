...
!npm install -g localtunnel # Menginstal localtunnel menggunakan npm
...
# Tunggu beberapa detik agar Streamlit sempat berjalan (opsional, tapi kadang membantu)
import time
time.sleep(3)

# Mengekspos port Streamlit (8501) menggunakan localtunnel
print("Menjalankan localtunnel untuk mengekspos aplikasi Streamlit...")
